...
<div class="container">
  ...
  <div class="accordion-item">
    ...
    <div class="row g-5">
       ...
       <h4>El valor mas alto de viajes de los periodos de <span class="badge bg-dark">transporte privado</span> es:</h4>
       ...
       <h4>El valor mas alto de viajes de los periodos de <span class="badge bg-dark">otros transportes</span> es:</h4>
       <p><span class="badge bg-secondary">
       <?php
